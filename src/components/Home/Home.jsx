...
function Home() {
  ...
  function sendmsg() {
    ...
    if (msgElement) {
      ...
      window.open('https://api.whatsapp.com/send?phone=8688561178&text=' + relmsg, '_blank');
    }
  }
  return (
...
<Alumni />
  ...
  <div id="chat-box">
    ...
    <div id="chat-msg">
      <p>Welcome to InternPixel, your gateway to exciting internship opportunities!</p>
      <div id="chat-form">
