        ...
        <ul className="cards1">
          <li className="cards1_item">
            <div className="card1">
              ...
              <span className="note1">Most requested internship💝</span>
          ...
          <li className="cards1_item">
            <div className="card1">
              <div className="card1_image">
              <span className="note1">Exclusive opportunity🔥</span>
          ...
          <li className="cards1_item">
            <div className="card1">
              <div className="card1_image">
              <span className="note1">Buzzworthy opportunity❤️‍🔥</span>
          ...
          <li className="cards1_item">
            <div className="card1">
              <div className="card1_image">
              <span className="note1">Don't miss out!🔥</span>
