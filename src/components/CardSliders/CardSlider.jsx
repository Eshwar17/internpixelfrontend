      ...
      <div className="main1">
        <ul className="cards1">
          <li className="cards1_item">
            <div className="card1">
              <div className="card1_image">
                <img src="https://www.iimtindia.net/Blog/wp-content/uploads/2021/08/Data-Science-Future-scope.jpg" alt="card"/>
              </div>
          ...
          <li className="cards1_item">
            <div className="card1">
              <div className="card1_image">
                ...
                <img src="https://wallpapercave.com/wp/wp8903936.jpg" alt="card"/>
              </div>
              <div className="card1_content">
                <h2 className="card1_title">
          ...
          <li className="cards1_item">
            <div className="card1">
              <div className="card1_image">
                <img src="https://img.freepik.com/free-vector/hand-drawn-flat-design-devops-illustration_23-2149387396.jpg?size=626&ext=jpg&ga=GA1.1.136392163.1683044531&semt=ais" alt="card"/>
              </div>
              <div className="card1_content">
                <h2 className="card1_title">
          ...
          <li className="cards1_item">
            <div className="card1">
              <div className="card1_image">
                <img src="https://img.freepik.com/free-vector/coding-round-composition_1284-40752.jpg?size=626&ext=jpg&ga=GA1.1.136392163.1683044531&semt=ais" alt="card"/>
              </div>
              <div className="card1_content">
                <h2 className="card1_title">
          ...
          <li className="cards1_item">
            <div className="card1">
              <div className="card1_image">
                <img src="https://img.freepik.com/free-vector/isometric-characters-illustration-human-resources-doing-interview_1284-24421.jpg?size=626&ext=jpg&ga=GA1.2.136392163.1683044531&semt=ais" alt="card"/>
              </div>
              <div className="card1_content">
                <h2 className="card1_title">
