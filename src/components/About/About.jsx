    ...
    <Stack direction={["column", "row"]} spacing={["4", "16"]} padding={"8"}>
      ...
      <VStack justifyContent={"center"} alignItems={["center", "flex-start"]}>
        ...
        <Text
          ...
          children={`Hi there, I'm Eshwar Nagaraj, the founder and software engineering instructor at GrapplTech. With a deep passion for both technology and education, I've dedicated my career to helping students and recent graduates launch their careers through impactful internship experiences. As a software engineer myself, I know firsthand the importance of hands-on, real-world experience in the tech industry. That's why I founded GrapplTech - to provide students with the opportunity to gain the skills, knowledge, and connections they need to succeed in this ever-evolving field.`}
        />
      </VStack>
    </Stack>
    <Stack direction={["column", "row"]} spacing={["4", "16"]} padding={"8"}>
